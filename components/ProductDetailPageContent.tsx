          ...
          <div id="purchase-panel">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button
                ...
                className="flex-1 bg-[#153532] hover:bg-[#0f2725] text-white py-4 px-6 font-bold tracking-wider transition-colors shadow-sm flex items-center justify-center gap-2"
              >
